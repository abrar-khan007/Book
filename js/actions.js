...
$(document).ready(function(){
	...
	//cat() is a funtion fetching category record from database 
	function cat(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	//brand() is a funtion fetching brand record from database 
	function brand(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	//product() is a funtion fetching product record from database
		function product(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	/*	when page is load successfully then there is a list of categories 
	*/
	...
	*/
	...
	/*
		At the top of page there is a search box we will take the user 
	...
	*/
	...
	/*
		whenever user click on send it to action.php to perform product qty updation operation
	*/
	...
	net_total();
	/*
		checkOutDetails() function works
