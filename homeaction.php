...
if(isset($_POST["categoryhome"])){
	$category_query = "SELECT * FROM category WHERE cat_id!=1";
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='store.php'>Cart Gallery</a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
            ...
            $sql = "SELECT COUNT(*) AS count_items FROM products,category WHERE product_cat=cat_id";
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									<div class='product-img'>
										<img src='book_images/$pro_image' alt=''>
									</div>
...
if(isset($_POST["gethomeProduct"])){
	...
	$product_query = "SELECT * FROM products,category WHERE product_cat=cat_id AND product_id BETWEEN 71 AND 74";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
			...
			echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='cart.php?p='$pro_id''>
